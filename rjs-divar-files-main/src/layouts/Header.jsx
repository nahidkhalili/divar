    ...
    <header className="flex flex-row justify-between items-center border-b-2 border-solid border-[rgb(234,234,234)] py-[10px] px-0 mb-[20px]">
      ...
      <div className="flex flex-row items-center gap-8">
          ...
          <div className="relative" ref={dropdownRef}>
            <div className=" flex flex-row items-center cursor-pointer w-[140px] px-6 text-gray-500 h-[50px] rounded-[3px] hover:bg-gray-200 active:bg-gray-200" onClick={()=>setActiveHeader(true)}>
              <img className="w-[14px]" src="/profile.svg" />
              <p className="text-[0.8rem] mr-2">دیوار من</p>
            </div>
            {activeHeader && <DropDownMenu className="absolute top-12" closeMenu={closeMenu} />}
          </div>
